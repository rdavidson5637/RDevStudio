      ...
      <header className="sticky top-0 z-[100] min-h-20 border-b border-border bg-base/95 backdrop-blur-sm">
        <div className="container-wide flex h-20 items-center justify-between gap-4 px-6">
          ...
          <div className="flex items-center gap-1 md:hidden">
            <Link
              href="/contact"
              className="rounded-md bg-primary px-3 py-2 text-xs font-semibold text-paper transition-colors hover:bg-[#d22b2b]"
            >
              Start a project
            </Link>
            <button
              type="button"
              className="flex h-11 w-11 shrink-0 items-center justify-center text-primary transition-colors hover:text-accent"
