...
export function ChampionsDraftSpotlight({
  ...
  return (
    <Link
      ...
      className={`group relative block overflow-hidden rounded-2xl border border-border-strong bg-overlay transition-all duration-normal ease-out hover:border-emerald-400/50 hover:shadow-card ${
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Image
              ...
              width={208}
              height={208}
              className="h-full w-full object-contain transition-transform duration-normal ease-out group-hover:scale-105"
            />
          </div>
        </div>
        ...
        <div className="min-w-0 flex-1 text-center sm:text-left">
          ...
          <span
            className={`mt-6 inline-flex items-center gap-2 rounded-lg bg-emerald-500 font-bold uppercase tracking-widest text-[#0f172a] transition-colors group-hover:bg-emerald-400 ${
