...
export function RugbyDraftSpotlight({
  ...
  return (
    <Link
      ...
      className={`group relative block overflow-hidden rounded-2xl border border-border-strong bg-overlay transition-all duration-normal ease-out hover:border-sky-400/50 hover:shadow-card ${
        isHero ? "p-8 sm:p-10 lg:p-12" : "p-6 sm:p-8"
      }`}
    >
      <div
        className="pointer-events-none absolute inset-y-0 left-0 w-1 bg-sky-400"
        aria-hidden="true"
      />
      ...
      >
        ...
        <div className="min-w-0 flex-1 text-center sm:text-left">
          <div className="mb-4 flex flex-wrap items-center justify-center gap-2 sm:justify-start">
            <span className="rounded-full border border-sky-400/60 bg-base px-3 py-1 text-[10px] font-bold uppercase tracking-widest text-sky-400">
              {RUGBY_DRAFT.badge}
            </span>
          ...
          <h2
            className={`mt-2 font-display font-bold tracking-tight text-[#f8fafc] ${
              isHero
          ...
          <p
            className={`mt-3 font-medium text-[#f8fafc] ${
          ...
          <span
            className={`mt-6 inline-flex items-center gap-2 rounded-lg bg-sky-500 font-bold uppercase tracking-widest text-[#0f172a] transition-colors group-hover:bg-sky-400 ${
